...
export function QuestionLayout({ state, status, remainingTime }: QuestionLayoutProps) {
  ...
  return (
    <MonitorLayout questionType={question.type} showHeaderQrCode>
      <div className="grid min-h-0 flex-1 grid-cols-[1228px_548px] gap-12 px-12 py-12">
        <section className="grid min-h-0 grid-rows-[257px_minmax(0,1fr)] gap-12">
          <div className="flex h-[257px] items-start gap-6 overflow-hidden rounded-[28px] border-2 border-border-soft bg-surface pt-4 pr-[38px] pb-[26px] pl-8 shadow-[0_10px_28px_0_rgba(25,32,133,0.1)]">
