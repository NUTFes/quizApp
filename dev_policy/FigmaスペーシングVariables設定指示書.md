...
3画面本体の34種類から、**奇数 px 3種（`13` `23` `29`）を除き、`19px` を `20px` に統合した**残り。件数は再集計結果（救済問題・早押し・ステータスバーを除いた本体のみ、計873件）による。
...
> **Figma に加える値変更はこれだけ。** 他の端数（`2` `13` `14` `23` `26` `29` `30` `38` `54` `62` `66px`、計140件）はすべて据え置きで確定している（→ 対応表 §10）。
